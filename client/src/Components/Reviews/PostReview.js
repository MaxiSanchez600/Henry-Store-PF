...
const PostReview = ({ show, closeModalHandler, id_order_review, id_product }) => {
  ...
  const [rating_send, setRating_Send] = useState(0)
  const [Content_send, setContent_Send] = useState(0)

  // ! POST REVIEW
  function onChangeValue_Score(event) {
    setRating_Send(event.target.value)
  }

  function onChangeValue_Content(event) {
    setContent_Send(event.target.value)
  }
      ...
      <label class="rating-label">CALIFICA TU PRODUCTO!
        <div class="ratingItemList">
          <div class="container3">
            <div class="feedback">
              <div class="rating" onChange={onChangeValue_Score}>
