...
const NavBar = () => {
  ...
  return (
    <div>
      ...
      <Modal isOpened={ModalCompleteData} onClose={() => setModalCompleteData(false)}>
        <CompleteData isOpened={ModalCompleteData} 
                        CompleteDataClose={() => setModalCompleteData(false)}
                        />
      </Modal>
      ...
      {user &&
        <div className="user_perfil">
          ...
          <div>
            <button onClick={() => setModalCompleteData(true)}>Completar Data</button>
          </div>
